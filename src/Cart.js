...
const Cart = ({
  ...
  const handleShippingAndOrder = async () => {
    try {
      // Call the handleShippingAddress function first
      const response = await axios.post(`/api/shippingaddress`, {
        ...shipping,
        user_id: userId,
      });
      ...
      // Then call the updateOrder function
    ...
    <div className="cart-container">
      ...
      {cartLineItems.length ? (
        <div className="cart-actions">
          ...
          <br />
          <p>All orders are to be picked up under your alias in the Walgreens pharmacy next to Wayne enterprice HQ in Gotham within 24h of order being made. Alfred, how do you stop speech to write .. Alfreeeed!...oh press this butto.</p>
          <form>
            <p>Street Address</p>
            <input
              type="text"
