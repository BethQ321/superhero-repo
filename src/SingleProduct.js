...
const SingleProduct = ({
  ...
  const filteredReviews = () => {
    return sortedReviews().filter(
      (review) =>
        ...
        (selectedRating === "" ||
          parseInt(review.rating) === parseInt(selectedRating))
    );
  };
  ...
  return (
    <div className="singleProduct-container">
      <div
        className="product-and-form-container"
      ...
      >
        <div className="Sproduct-container">
          ...
          <div
            className="Sproduct-description"
        ...
        <div className="review-form">
          ...
          <form onSubmit={handleReviewSubmit}>
            ...
            <div className="rating-row">
              <label style={{ paddingTop: "8px" }} htmlFor="rating">
                Rating (0-5):
              </label>
              <select
                id="rating"
      ...
      <div className="reviews-container">
        ...
        <div>
          <label htmlFor="sortMethod" style={{ fontSize: "16px" }}>
            Sort by:{" "}
          </label>
          <select
            id="sortMethod"
        ...
        >
          <div>
            <label htmlFor="ratingFilter" style={{ fontSize: "16px" }}>
              View By Rating:{" "}
            </label>
            <select
              id="ratingFilter"
          ...
          <button
            onClick={resetFilter}
            style={{ fontSize: "14px", border: "2px solid #373737" }}
          >
            View All Reviews
          </button>
        </div>
          ...
          <ul className="reviews-list">
            {filteredReviews().map((review) => (
              <li key={review.id} className="review-box">
                ...
                <div className="review-name">
                  <p>
                    Rating: {review.rating}/5 | Review By: {review.name}
                  </p>
                </div>
