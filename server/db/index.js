...
const seed = async()=> {
  ...
  const [moe, lucy, ethyl, jonas, matthew, billy, devin] = await Promise.all([
    createUser({ username: 'moe', password: 'm_password', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email1@email.com', is_admin: false}),
    createUser({ username: 'lucy', password: 'l_password', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'emai2l@email.com', is_admin: false}),
    createUser({ username: 'ethyl', password: '1234', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email3@email.com', is_admin: true}),
    createUser({ username: 'jonas', password: 'j123', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'emai4l@email.com', is_admin: true}),
    createUser({ username: 'matthew', password: 'm123', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email5@email.com', is_admin: true}),
    createUser({ username: 'billy', password: 'b123', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email6@email.com', is_admin: true}),
    createUser({ username: 'devin', password: 'd123', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email7@email.com', is_admin: true}),
  ]);
