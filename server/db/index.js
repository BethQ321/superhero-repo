...
const seed = async()=> {
  ...
  const [moe, lucy, ethyl, jonas, matthew, billy, devin] = await Promise.all([
    createUser({ username: 'moe', password: 'm_password', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email@email.com', is_admin: false}),
    createUser({ username: 'lucy', password: 'l_password', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email@email.com', is_admin: false}),
    createUser({ username: 'ethyl', password: '1234', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email@email.com', is_admin: true}),
    createUser({ username: 'jonas', password: 'j123', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email@email.com', is_admin: true}),
    createUser({ username: 'matthew', password: 'm123', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email@email.com', is_admin: true}),
    createUser({ username: 'billy', password: 'b123', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email@email.com', is_admin: true}),
    createUser({ username: 'devin', password: 'd123', Fname: 'FirstName', Lname: 'LastName', phone: '555-555-5555', email: 'email@email.com', is_admin: true}),
  ]);
