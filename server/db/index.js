...
const seed = async () => {
  ...
  const [
    ...
    createProduct({
      name: "Umbrella_Shotgun",
      price: 100,
      image:
        "https://cdn.trendhunterstatic.com/thumbs/gun-umbrella.jpeg?auto=webp",
      description:
        "A classic weapon that all superheroes or villains dream of using, rain or shoot it will do the job and then some!",
      vip_only: false,
    }),
    createProduct({
      name: "Freezer_Ray",
      price: 100,
      image:
        "https://www.julienslive.com/images/lot/3875/387512_xl.jpg?ts=1694578248",
      description:
        "Freeze gun that emits a cold ray capable of freezing anything it touches.",
      vip_only: false,
    }),
    createProduct({
      name: "Shark_laser",
    ...
    createProduct({
      ...
      price: 100,
      image: "https://m.media-amazon.com/images/I/81-2z43BSwL._AC_SX679_.jpg",
      description:
